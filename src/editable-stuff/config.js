...
const mainBody = {
  ...
  icons: [
    {
      image: "fa-linkedin",
      url: "https://www.linkedin.com/in/oskardurlo/",
    },
  ],
};
...
const skills = {
  ...
  heading: "Skills",
  hardSkills: [
    { name: "Interpreting Data", value: 90 },
    { name: "Financial Planning", value: 75 },
    { name: "Project Management", value: 85 },
    { name: "Request for Proposal Writing", value: 65 },
    { name: "Microsoft Office", value: 90 },
    { name: "Bookkeeping", value: 65 },
    { name: "Programming", value: 55 },
    { name: "Presenting", value: 80 },
  ],
  softSkills: [
...
const getInTouch = {
  ...
  message:
    "I'm currently looking for Business Consultant and Project Management opportunities! If you know of any positions available, if you have any questions, or if you just want to say hi, please feel free to email me at",
  email: "oskardurlo@gmail.com",
};
